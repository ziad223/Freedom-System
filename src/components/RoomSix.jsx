...
import { addUser, deleteUser } from '../redux/slices/RoomSixSlice';
...
const RoomSix = () => {
    ...
    const [residual , setResidual] = useState();
      ...
      const roomSixUsers = useSelector(state =>state.roomSix.users);
  ...
  return (
    ...
    <div className='english-room'>
        <h1>Room 6 English</h1>
        <h2  className='length'> Number Of Student : {roomSixUsers.length}</h2>
     ...
     {roomSixUsers.length > 0 ? <table border = '2' cellPadding = '10'>
        <tr>
            <th>id</th>
            <th>name</th>
            <th>Phone Number</th>
        ...
        {roomSixUsers.length > 0 && roomSixUsers.filter((user) =>
